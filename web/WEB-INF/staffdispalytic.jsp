...
<html>
    ...
    <body style="background-color:powderblue">
        ...
        <a href="index.html" ><input type="submit" value="Add New Ticket Details" name="sub" style="background-color: #CCCCFF"> </a>
        <br>    
        <br>  
        <table border="2px  black groove" bgcolor="#c6e3f7">
            <thead>
                ...
                <tr height="40px" >
                    <td width="120px%"><b><center>Ticket Id</center><b></td>
                     ...
                     <td width="90px"><b><center>Update</center><b></td>
                     <td width="90px"><b><center>Delete</center><b></td>
                </tr>
           ...
           {%>
               ...
               <tr height="30px">
                   ...
                   <td> 
               <center><a href="updateTTjsp.jsp" ><input type="submit" value="Update" name="update"></a></center>
                   </td>
                   <td>
                   <center><a href="deleteTTjsp.jsp" ><input type="reset" value="Delete" name="del" > </a></center>
                   </td>
               </tr>
